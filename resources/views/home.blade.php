...
<html lang="en">
    ...
    <body class="home">
        ...
        <section class="hero container-fluid">
            <div class="hero-text">
                Explore Endless Internship Opportunities
            </div>
        ...
        <section class="web-description container-fluid">
            ...
            <div class="text-image">
                <p class="text-desc">
                    Lorem ipsum dolor sit amet consectetur. Fermentum id
                    facilisis ultrices aliquet. Semper in euismod cursus euismod
                    non ornare turpis sit a. Molestie lectus nullam proin justo
                    faucibus pharetra facilisis. Consectetur iaculis senectus
                    pellentesque sem a. Libero donec nullam sed in pretium nulla
                    massa nunc pulvinar. Tortor enim turpis fringilla
                    pellentesque. Blandit maecenas ultricies mauris erat cras
                    lectus nisl. Dictum enim diam vel libero suspendisse eget
                ...
                <div class="card comp-1" style="width: 346px">
                    ...
                    <div class="card-body">
                        <div class="card-desc">
                            <h1
                                class="card-title"
                                style="color: #2d3648; font-size: 20px"
                            >
                                Retail Banking Card Funding Officer
                            </h1>
                            <h1
                                class="card-title"
                                style="color: #717d96; font-size: 16px"
                            >
                                PT. Bank Mega, Tbk
                            </h1>
                            ...
                            <p
                                class="card-text"
                                style="color: #717d96; font-size: 12px"
                            >
